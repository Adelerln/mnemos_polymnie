        ...
        <div className="flex items-center gap-4">
          ...
          {user ? (
            ...
            >
              ...
              {isMenuOpen ? (
                <div className="absolute right-0 top-full z-50 mt-2 w-48 rounded-2xl border border-neutral-200 bg-white p-3 text-[11px] font-medium uppercase tracking-[0.18em] text-neutral-600 shadow-lg">
                  <button
                    type="button"
