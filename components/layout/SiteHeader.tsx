        ...
        <div className="flex items-center gap-6">
          ...
          {user ? (
            ...
            >
              ...
              {isMenuOpen ? (
                <div className="absolute left-1/2 top-full z-20 mt-2 w-48 -translate-x-1/2 rounded-2xl border border-neutral-200 bg-white p-3 text-[11px] font-medium uppercase tracking-[0.18em] text-neutral-600 shadow-lg">
                  <button
                    type="button"
